...
require (
	...
	knative.dev/reconciler-test v0.0.0-20240704013940-3a59c9dfb680 // indirect
	sigs.k8s.io/json v0.0.0-20221116044647-bc3834ca7abd // indirect
	sigs.k8s.io/structured-merge-diff/v4 v4.4.1 // indirect
	sigs.k8s.io/yaml v1.4.0 // indirect
)

replace knative.dev/eventing v0.39.1 => github.com/Cali0707/eventing v0.0.0-20240729120457-d60a069f46da
